...
namespace JoculSpanzuratoarea.Pages.Spanzuratoarea
{
    public class SpanzuratoareaModel : PageModel
    {
        ...
        public SpanzuratoareaModel(ApplicationDbContext context)
        {
            _context = context;
        ...
        {
            return RedirectToPage("/Spanzuratoarea/Spanzuratoarea");
